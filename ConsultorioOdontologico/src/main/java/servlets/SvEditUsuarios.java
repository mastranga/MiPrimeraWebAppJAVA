...
public class SvEditUsuarios extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario usu = controlLog.getUsuarios(id);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String claveUsuario = request.getParameter("contrasenia");
        
        Usuario usu = (Usuario) request.getSession().getAttribute("usuEditar");
        usu.setNombreUsuario(nombreUsuario);
        usu.setRol(rolUsuario);
        usu.setContrasenia(claveUsuario);
        
        controlLog.editUsuario(usu);
